...
public class FlowPathStatusConverterTest {
    ...
    public void shouldConvertToGraphProperty() {
        ...
        assertEquals("up", converter.toGraphProperty(FlowPathStatus.UP));
        assertEquals("down", converter.toGraphProperty(FlowPathStatus.DOWN));
    ...
    public void shouldConvertToEntity() {
        ...
        assertEquals(FlowPathStatus.UP, converter.toEntityAttribute("UP"));
        assertEquals(FlowPathStatus.UP, converter.toEntityAttribute("up"));
