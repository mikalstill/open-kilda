 ...
 * bandwidth and description, paths, encapsulation.
 */
@Data
@NoArgsConstructor
...
public class Flow implements Serializable {
    ...
    private FlowPath validatePath(FlowPath path) {
        ...
        checkArgument(Objects.equals(path.getSrcSwitch().getSwitchId(), getSrcSwitch().getSwitchId())
                ...
                "Path source %s doesn't correspond to any of flow endpoints.", path.getSrcSwitch());
        ...
        checkArgument(Objects.equals(path.getDestSwitch().getSwitchId(), getSrcSwitch().getSwitchId())
                ...
                "Path destination %s doesn't correspond to any of flow endpoints.", path.getSrcSwitch());
