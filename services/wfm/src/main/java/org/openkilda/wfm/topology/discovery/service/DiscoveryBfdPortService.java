...
public class DiscoveryBfdPortService extends AbstractDiscoveryService {
    private final Map<Endpoint, BfdPortFsm> controller = new HashMap<>();
    ...
    public DiscoveryBfdPortService(DiscoveryOptions options) {
        super(options);
    }
}
