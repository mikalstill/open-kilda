...
public class UniIslDiscoveryCommand extends UniIslCommand {
    ...
    public UniIslDiscoveryCommand(IslInfoData speakerDiscoveryEvent) {
        super(new Endpoint(speakerDiscoveryEvent.getDestination()));
        this.speakerDiscoveryEvent = speakerDiscoveryEvent;
    }
