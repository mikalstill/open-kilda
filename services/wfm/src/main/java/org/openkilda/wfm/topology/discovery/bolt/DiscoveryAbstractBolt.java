...
public abstract class DiscoveryAbstractBolt extends AbstractBolt {
    private final DiscoveryServiceFactory serviceFactory;

    protected transient DiscoveryService discoveryService;

    public DiscoveryAbstractBolt(DiscoveryServiceFactory serviceFactory) {
    ...
    protected void init() {
        super.init();
        discoveryService = serviceFactory.produce();
    }
}
